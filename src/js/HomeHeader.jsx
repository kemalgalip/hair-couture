...
export default function Header(props) {
    ...
    return (
        <header className="header-homepage" ref={props.homeHeaderRef}>
            <a href="/"><img className="header-homepage-logo" src={isDarkLogo ? logoDark : logoLight} width="540" height="242" /></a>
            {windowWidth > 1024 ?
                ...
                :
                <section className="header-homepage-menu-button" tabIndex={0}>
                    <div className="header-homepage-menu-stripe"></div>
                    <div className="header-homepage-menu-stripe"></div>
                    <div className="header-homepage-menu-stripe"></div>
