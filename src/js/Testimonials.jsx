            ...
            <div className="testimonials-div" ref={testimonialsDivRef}>
                ...
                <div className="testimonials-testimonials" ref={testimonialsRef}>
                    <div className="testimonials-testimonial">
                        ...
                        <p>&ldquo;I had an amazing experience at this hair salon! The stylists were professional and friendly, and they listened to my requests. I walked out feeling confident and beautiful.&rdquo;</p>
                    </div>
                    <div className="testimonials-testimonial">
                        <img src={img2} alt="Profile Picture" width="250" height="250" />
                        <h4>Jessica</h4>
                        <h3>&ldquo;Love My Hair&ldquo;</h3>
                        <p>&ldquo;I absolutely love my new haircut! The stylist was able to perfectly capture the look I wanted. I've received so many compliments on my hair since I left the salon.&rdquo;</p>
                    </div>
                    <div className="testimonials-testimonial">
                        <img src={img3} alt="Profile Picture" width="250" height="250" />
                        <h4>Emily</h4>
                        <h3>&ldquo;Best Hair Salon&ldquo;</h3>
                        <p>&ldquo;This is hands down the best hair salon in town! The staff are knowledgeable and skilled, and they always make me feel welcome. I wouldn't go anywhere else.&rdquo;</p>
                    </div>
                    <div className="testimonials-testimonial">
                        <img src={img4} alt="Profile Picture" width="250" height="250" />
                        <h4>Maria</h4>
                        <h3>&ldquo;Perfect Color&ldquo;</h3>
                        <p>&ldquo;I came in wanting a drastic change to my hair color, and the stylist delivered! My new hair color is perfect and I couldn't be happier.&rdquo;</p>
                    </div>
                    <div className="testimonials-testimonial">
                        <img src={img5} alt="Profile Picture" width="250" height="250" />
                        <h4>Chloe</h4>
                        <h3>&ldquo;Excellent Service&ldquo;</h3>
                        <p>&ldquo;The service at this hair salon is excellent! The staff are friendly and attentive, and they make sure that I'm comfortable throughout my appointment. I highly recommend this salon.&rdquo;</p>
                    </div>
                    <div className="testimonials-testimonial">
                        <img src={img6} alt="Profile Picture" width="250" height="250" />
                        <h4>Jason</h4>
                        <h3>&ldquo;Great Haircut&ldquo;</h3>
                        <p>&ldquo;I received a great haircut at this salon! The stylist took the time to listen to what I wanted and provided expert advice. I'll definitely be back.&rdquo;</p>
                    </div>
                    <div className="testimonials-testimonial">
                        <img src={img7} alt="Profile Picture" width="250" height="250" />
                        <h4>Laura</h4>
                        <h3>&ldquo;Beautiful Results&ldquo;</h3>
                        <p>&ldquo;The results of my hair appointment were beautiful! The stylist was able to perfectly execute the style I wanted. I felt like a new person when I left the salon.&rdquo;</p>
                    </div>
                    <div className="testimonials-testimonial">
                        <img src={img8} alt="Profile Picture" width="250" height="250" />
                        <h4>Rachel</h4>
                        <h3>&ldquo;Skilled Stylists&ldquo;</h3>
                        <p>&ldquo;The stylists at this hair salon are so skilled! They have a great eye for detail and are able to deliver exceptional results every time.&rdquo;</p>
                    </div>
                    <div className="testimonials-testimonial">
                    ...
                    <div className="testimonials-testimonial">
                        ...
                        <p>&ldquo;The service at this salon is top notch! The stylists take the time to get to know their clients and provide personalized recommendations. I always leave feeling pampered and happy.&rdquo;</p>
                    </div>
                    <div className="testimonials-testimonial">
                        <img src={img11} alt="Profile Picture" width="250" height="250" />
                        <h4>Olivia</h4>
                        <h3>&ldquo;Beautiful Updo&ldquo;</h3>
                        <p>&ldquo;The stylist at this salon created a beautiful updo for my special event! I received so many compliments on my hair that night. Thank you!&rdquo;</p>
                    </div>
                    <div className="testimonials-testimonial">
                        <img src={img12} alt="Profile Picture" width="250" height="250" />
                        <h4>Michael</h4>
                        <h3>&ldquo;Highly Recommend&ldquo;</h3>
                        <p>&ldquo;I highly recommend this hair salon to anyone looking for exceptional service and results! The staff go above and beyond to ensure that their clients are happy.&rdquo;</p>
                    </div>
                </div>
                <button
