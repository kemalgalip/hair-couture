            ...
            <div className="testimonials-div" ref={testimonialsDivRef}>
                ...
                <div className="testimonials-testimonials" ref={testimonialsRef}>
                    <div className="testimonials-testimonial">
                        <img className="testimonials-testimonial-pp" src={img1} alt="Profile Picture" width="250" height="250" loading="lazy" />
                    ...
                    <div className="testimonials-testimonial">
                        <img className="testimonials-testimonial-pp" src={img2} alt="Profile Picture" width="250" height="250" loading="lazy" />
                    ...
                    <div className="testimonials-testimonial">
                        <img className="testimonials-testimonial-pp" src={img3} alt="Profile Picture" width="250" height="250" loading="lazy" />
                    ...
                    <div className="testimonials-testimonial">
                        <img className="testimonials-testimonial-pp" src={img4} alt="Profile Picture" width="250" height="250" loading="lazy" />
                    ...
                    <div className="testimonials-testimonial">
                        <img className="testimonials-testimonial-pp" src={img5} alt="Profile Picture" width="250" height="250" loading="lazy" />
                    ...
                    <div className="testimonials-testimonial">
                        <img className="testimonials-testimonial-pp" src={img6} alt="Profile Picture" width="250" height="250" loading="lazy" />
                    ...
                    <div className="testimonials-testimonial">
                        <img className="testimonials-testimonial-pp" src={img7} alt="Profile Picture" width="250" height="250" loading="lazy" />
                    ...
                    <div className="testimonials-testimonial">
                        <img className="testimonials-testimonial-pp" src={img8} alt="Profile Picture" width="250" height="250" loading="lazy" />
                    ...
                    <div className="testimonials-testimonial">
                        <img className="testimonials-testimonial-pp" src={img9} alt="Profile Picture" width="250" height="250" loading="lazy" />
                    ...
                    <div className="testimonials-testimonial">
                        <img className="testimonials-testimonial-pp" src={img10} alt="Profile Picture" width="250" height="250" loading="lazy" />
                    ...
                    <div className="testimonials-testimonial">
                        <img className="testimonials-testimonial-pp" src={img11} alt="Profile Picture" width="250" height="250" loading="lazy" />
                    ...
                    <div className="testimonials-testimonial">
                        <img className="testimonials-testimonial-pp" src={img12} alt="Profile Picture" width="250" height="250" loading="lazy" />
